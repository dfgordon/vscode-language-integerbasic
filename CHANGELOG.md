...
* Workspace scan establishes CHAIN relationships
    - allows chained variables to be included in analysis
* Range-checking works with literal expressions

## [2.1.1] - 2026-01-11

### Fixes

* symbols update when switching tabs
* docstring shows when hovering on line number reference
